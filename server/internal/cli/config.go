...
// CLIConfig holds persistent CLI settings. Workspace assignments for the
// daemon live on the server now (daemon_workspace) — there is no longer a
// local watched-workspaces list.
